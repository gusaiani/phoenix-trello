defmodule GusaianiPhoenixTrello.BoardController do
  use GusaianiPhoenixTrello.Web, :controller

  plug Guardian.Plug.EnsureAuthenticated, handler: GusaianiPhoenixTrello.SessionController
  plug :scrub_params, "board" when action in [:create]

  alias GusaianiPhoenixTrello.{Repo, Board, UserBoard}
