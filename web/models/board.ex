defmodule GusaianiPhoenixTrello.Board do
  use GusaianiPhoenixTrello.Web, :model

  alias __MODULE__
  alias GusaianiPhoenixTrello.{Repo, Permalink, List, Comment, Card, UserBoard, User}
...
defimpl Poison.Encoder, for: GusaianiPhoenixTrello.Board do
  def encode(model, options) do
    model
    |> Map.take([:name, :lists, :user, :members])
    |> Map.put(:id, GusaianiPhoenixTrello.Board.slug_id(model))
